...
static int pxrc_open(struct input_dev *input)
{
	...
	printk(KERN_INFO "pxrc_open(): kernel analytics variable: %s = %s \n",virgo_kernel_analytics_conf[0].key, virgo_kernel_analytics_conf[0].value);
...
{
	printk(KERN_INFO "pxrc_probe(): kernel analytics variable: %s = %s \n",virgo_kernel_analytics_conf[0].key, virgo_kernel_analytics_conf[0].value);
