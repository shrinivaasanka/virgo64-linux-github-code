...
/* 
	VIRGO File System syscall related declarations and datastructures 
*/

#ifndef _VIRGO_FS_SYSCALL_H_
#define _VIRGO_FS_SYSCALL_H_
...
struct virgo_filesystem_ktls_config
{
        char* key;
        char* value;
};

struct virgo_filesystem_ktls_config virgo_filesystem_ktls_conf[10];
