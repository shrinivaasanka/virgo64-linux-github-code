...
__attribute__((section("__versions"))) = {
	...
	{ 0xd199b9f8, __VMLINUX_SYMBOL_STR(kernel_sock_shutdown) },
...
"depends=virgo_kernel_analytics,kingcobra_main_kernelspace,virgo_ktls";


MODULE_INFO(srcversion, "7D7C8E5DCC084C5DA0EE191");
